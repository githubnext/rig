...
const analyzeChanges = agent({ model: "github-copilot/gpt-5.4-mini",
...
const chooseVersion = agent({ model: "github-copilot/gpt-5.4-mini",
...
const draftRelease = agent({ model: "github-copilot/gpt-5.4-mini",
...
const releaseAgent = agent({ model: "github-copilot/gpt-5.4-mini",
