...
const localGuide = agent({ model: "github-copilot/gpt-5.4-mini", instructions: "Suggest authentic places and activities for a 3-day trip to Egypt.", output: s.object({ ideas: s.array(s.string) }) });
const languageTips = agent({ model: "github-copilot/gpt-5.4-mini", instructions: "Suggest communication tips for a 3-day trip to Egypt.", output: s.object({ tips: s.array(s.string) }) });
