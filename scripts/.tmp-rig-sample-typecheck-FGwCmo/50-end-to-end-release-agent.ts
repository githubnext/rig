...
const analyzeChanges = agent({ model: "typecheck",
...
const chooseVersion = agent({ model: "typecheck",
...
const draftRelease = agent({ model: "typecheck",
...
const releaseAgent = agent({ model: "typecheck",
