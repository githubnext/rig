...
const refactorOne = agent({ model: "typecheck", instructions: "Suggest one minimal metadata cleanup for a rig sample.", output: s.object({ file: s.string, change: s.string }) });
